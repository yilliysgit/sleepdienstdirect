...
import { Phone, MapPin, Clock, Shield, ArrowRight, CheckCircle, Lightning } from '@phosphor-icons/react';
import { motion } from 'framer-motion';
import { useState } from 'react';

export default function AutoTransportHero() {
  ...
  const quickFacts = [
    ...
    { icon: Shield, text: '100% verzekerd transport', highlight: '€2M dekking' },
    { icon: MapPin, text: 'Heel Amsterdam & omgeving', highlight: '24/7' }
  ];
  ...
  return (
    <section className="relative min-h-[90vh] overflow-hidden bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900">
      ...
      <div className="absolute inset-0">
        <img
          src="/images/sleepdienst.jpg"
          alt="Auto transport Amsterdam - Professionele sleepdienst"
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
              Pech in Amsterdam? Wij zijn binnen 30 minuten bij je. Snel, betaalbaar en 100% verzekerd.
            </p>
            ...
            >
              ...
              10.000+ tevreden klanten • 4.9/5 sterren • Geen verborgen kosten
            </motion.p>
          </motion.div>
            ...
            <div className="relative bg-white rounded-3xl shadow-2xl shadow-gray-900/50 p-8 md:p-10 border border-gray-100">
              ...
              <div className="mt-6 pt-6 border-t border-gray-100 space-y-3">
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-black text-gray-900">Vanaf €89</span>
                </div>
                <div className="flex items-center justify-between text-sm">
              ...
              <div className="mt-6 grid grid-cols-3 gap-3">
                {['24/7', 'Vaste prijzen', 'Direct hulp'].map((badge) => (
