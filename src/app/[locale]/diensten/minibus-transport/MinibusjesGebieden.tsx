...
import { MapPin, CheckCircle, Phone, Clock, ArrowRight, Lightning, Truck } from '@phosphor-icons/react';
import { motion } from 'framer-motion';

export default function MiniBusjesGebieden() {
  ...
  const omliggendeGemeenten = [
    { naam: 'Amstelveen', afstand: '10 km', prijs: '€119', busjes: 'Tot 3 tegelijk' },
    { naam: 'Diemen', afstand: '8 km', prijs: '€119', busjes: 'Tot 3 tegelijk' },
    { naam: 'Zaandam', afstand: '15 km', prijs: '€149', busjes: 'Tot 3 tegelijk' },
    { naam: 'Hoofddorp', afstand: '18 km', prijs: '€149', busjes: 'Tot 3 tegelijk' },
    { naam: 'Haarlem', afstand: '25 km', prijs: '€189', busjes: 'Tot 3 tegelijk' },
    { naam: 'Purmerend', afstand: '20 km', prijs: '€149', busjes: 'Tot 3 tegelijk' },
    { naam: 'Almere', afstand: '30 km', prijs: '€189', busjes: 'Tot 3 tegelijk' },
    { naam: 'Hilversum', afstand: '35 km', prijs: '€189', busjes: 'Tot 3 tegelijk' },
    { naam: 'Utrecht', afstand: '50 km', prijs: '€229', busjes: 'Tot 3 tegelijk' },
    { naam: 'Alkmaar', afstand: '45 km', prijs: '€229', busjes: 'Tot 3 tegelijk' },
    { naam: 'Leiden', afstand: '45 km', prijs: '€229', busjes: 'Tot 3 tegelijk' },
    { naam: 'Den Haag', afstand: '65 km', prijs: '€279', busjes: 'Tot 3 tegelijk' }
  ];

  const popularRoutes = [
    { van: 'Amsterdam Centrum', naar: 'Schiphol', tijd: '25 min', prijs: '€149', info: 'Ook meerdere busjes' },
    { van: 'Amsterdam Noord', naar: 'Zaandam', tijd: '15 min', prijs: '€119', info: 'Zakelijk veel gekozen' },
    { van: 'Amsterdam Zuid', naar: 'Amstelveen', tijd: '10 min', prijs: '€119', info: 'Snelste route' },
    { van: 'Amsterdam Oost', naar: 'Almere', tijd: '30 min', prijs: '€189', info: 'Ook voor bedrijven' },
    { van: 'Amsterdam West', naar: 'Haarlem', tijd: '25 min', prijs: '€189', info: 'Volume korting' },
    { van: 'Amsterdam', naar: 'Utrecht', tijd: '40 min', prijs: '€229', info: 'Tot 3 busjes' }
  ];

  const zakelijkeHotspots = [
    { gebied: 'Bedrijventerrein Sloterdijk', info: 'Veel verhuurbedrijven' },
    { gebied: 'Schiphol / Hoofddorp', info: 'Zakelijk transport' },
    { gebied: 'Amsterdam Zuidoost', info: 'Kantoorlocaties' },
    { gebied: 'Havengebied', info: 'Logistieke bedrijven' }
  ];
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-black text-gray-900 mb-6 leading-tight">
            Mini busjes transport in{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-orange-600">
              heel Amsterdam
            </span>
          </h2>
          <p className="text-xl text-gray-600 leading-relaxed">
            Vito, Transporter, Transit - binnen 30 minuten bij je. Ook meerdere busjes tegelijk.
          </p>
        </motion.div>
          ...
          <div className="bg-white rounded-3xl border border-gray-200 shadow-xl p-8 md:p-12">
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Mini busjes transport binnen 30 minuten</p>
              </div>
            </div>
        ...
        >
          <div className="bg-gradient-to-br from-blue-50 to-white rounded-3xl border border-blue-200 p-8 md:p-12">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-gray-600">Veel actief in deze gebieden voor bedrijven</p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {zakelijkeHotspots.map((hotspot, i) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.5, delay: i * 0.1 }}
                  className="bg-white rounded-xl border border-blue-200 p-6 text-center hover:shadow-lg hover:border-orange-500 transition-all"
                >
                  <MapPin weight="duotone" className="w-8 h-8 text-orange-500 mx-auto mb-3" />
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600">Mini busjes transport door heel Noord-Holland</p>
          </div>
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div>
                    ...
                    <div className="text-xs text-orange-600 font-bold">{gemeente.busjes}</div>
                  </div>
          ...
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="relative">
              <div className="text-center mb-8">
                ...
                <p className="text-lg text-gray-300">Meest gekozen trajecten voor mini busjes</p>
              </div>
                ...
                {popularRoutes.map((route, i) => (
                  ...
                  >
                    <div className="flex items-center gap-2 mb-4">
                      <Truck weight="fill" className="w-5 h-5 text-orange-400" />
                    ...
                    <div className="text-xs text-orange-300 font-bold">{route.info}</div>
                  </motion.div>
                ))}
              </div>
            </div>
          ...
          <div className="inline-block bg-gradient-to-r from-orange-500 to-orange-600 rounded-3xl p-8 md:p-12 relative overflow-hidden shadow-2xl">
            ...
            <div className="relative">
              ...
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                Geen probleem! We rijden door heel Nederland. Ook meerdere busjes tegelijk mogelijk.
              </p>
              <motion.a
                href="tel:0625375323"
                whileHover={{ scale: 1.05 }}
